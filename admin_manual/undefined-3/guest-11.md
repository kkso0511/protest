...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/undefined-3/guest-11
---
...
*   수정 대상 사용자 ID가 등록되어 있지 않은 경우에는 ‘등록되지 않은 사용자 ID입니다.’라는 오류가 표시됩니다.
    ...
    Guest 추가에 대해서는 [Guest를 일괄 등록하는 방법](https://help.directcloud.net/admin_manual/undefined-3/guest-10)을 참고해 주시기 바랍니다.
