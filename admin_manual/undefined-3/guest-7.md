...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/undefined-3/guest-7
---
...
* Guest에게는 ‘보안 정책’ > ‘사용권한’ 메뉴의 설정이 적용되지 않기 때문에, 사용 권한 설정 항목이 없습니다.\
  다만, [Guest의 링크 생성 가능 여부를 설정하는 방법](https://help.directcloud.net/admin_manual/undefined-3/guest-13)을 통해 모든 Guest에 대해 링크 생성 허용 여부를 설정할 수는 있습니다.
