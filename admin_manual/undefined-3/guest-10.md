...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/undefined-3/guest-10
---
...
*   이미 동일한 사용자 ID의 Guest가 등록되어 있는 경우에는 ‘이미 등록된 ID입니다.’라는 오류가 표시됩니다.
    ...
    Guest 정보 수정에 대해서는 [Guest 정보를 일괄로 변경하는 방법](https://help.directcloud.net/admin_manual/undefined-3/guest-11)을 참고해 주시기 바랍니다.
