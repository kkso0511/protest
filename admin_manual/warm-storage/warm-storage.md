...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/warm-storage/warm-storage
---
...
*   Shared Box의 폴더와 파일이 Warm Storage로 이동되면, 이동 전 위치에 표시되는 정보를 고스트라고 부릅니다.\
    ...
    *   사용자 페이지에서의 고스트 표시 예(파일)
    ...
    고스트를 활용해 폴더나 파일 정보를 확인하거나 원래 위치로 되돌리는 방법은 [사용자 페이지에서 고스트(Ghost)를 조작하는 방법](https://help.directcloud.net/user_manual/warm-storage/ghost)을 참고해주시기 바랍니다.
...
* '고스트 표시 설정'을 '사용 안함'으로 설정하면, 이미 존재하는 고스트는 비표시됩니다.\
  ...
  Warm Storage로 이동된 폴더 및 파일의 정보를 확인하는 방법에 대해서는, [Warm Storage로 폴더 또는 파일을 이동하는 방법](https://help.directcloud.net/user_manual/warm-storage/web-drive-warm-storage)을 참조해 주십시오.
