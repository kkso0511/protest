...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/warm-storage/warm-storage-2
---
...
1. '공유 설정' > 'Shared Box' 메뉴를 클릭한 후, 폴더 트리에서 제1계층 이후의 폴더를 클릭합니다.\
   자세한 절차에 대해서는, [폴더에 저장된 폴더와 파일을 목록으로 표시하는 방법](https://help.directcloud.net/admin_manual/undefined-4/undefined-4)의 '제2계층 이후의 폴더·파일 목록을 표시하기'를 참조해 주십시오.
