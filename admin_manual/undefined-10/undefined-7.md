...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/undefined-10/undefined-7
---
...
<table><thead><tr><th width="100">No.</th><th>설명</th></tr></thead><tbody><tr><td>❶</td><td>업로드 요청의 설정 정보가 표시됩니다.<br>자세한 내용은 <a href="https://help.directcloud.net/user_manual/undefined-4/web-drive-10">계정이 없는 상대로부터 파일을 받는 방법(업로드 요청 기능)</a>의 '절차'를 참조해 주십시오.</td></tr><tr><td>❷</td><td><p>업로드 요청에 파일이 업로드된 이력이 표시됩니다.<br>자세한 내용은 아래와 같습니다.</p><ul><li>업로드한 사용자의 메일 주소</li><li>업로드 일시</li><li>접속 원본의 IP 주소</li><li>업로드 화면에서 입력한 메시지</li><li>업로드한 파일의 이름 및 용량</li></ul></td></tr></tbody></table>
