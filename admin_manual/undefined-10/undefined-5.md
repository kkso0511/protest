...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/undefined-10/undefined-5
---

# 사용자가 생성한 링크를 삭제하는 방법

### 개요 <a href="#a03" id="a03"></a>

이 매뉴얼에서는 '로그 현황' > '링크 현황' 메뉴에서 사용자가 만든 링크를 삭제하는 방법에 대해 설명합니다.
...
* '동작' 열에 '만료' 또는 '삭제'로 표시된 링크는 삭제할 수 없습니다.
...
2. '링크 현황'에서 '동작' 열의 휴지통 버튼을 클릭합니다.
...
4. 삭제한 링크의 '상태'가 '삭제'로 변경되었는지 확인합니다.
