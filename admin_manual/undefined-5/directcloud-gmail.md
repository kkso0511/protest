...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/undefined-5/directcloud-gmail
---
...
1. 사용자 페이지에서 [\[Mobile\] 공유 링크를 만들고 보내는 방법](https://help.directcloud.net/user_manual/undefined-4/mobile-1), [\[Mobile\] 계정이 없는 상대로부터 파일을 받는 방법](https://help.directcloud.net/user_manual/undefined-4/mobile-11)에 따라 공유 링크 또는 업로드 요청 화면 중 하나를 표시합니다.
