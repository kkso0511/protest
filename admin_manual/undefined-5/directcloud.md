...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/undefined-5/directcloud
---
...
1.  사용자 페이지에서 [\[Web, Drive\] 링크를 생성해 공유하는 방법](https://help.directcloud.net/user_manual/undefined-4/web-drive), [파일을 이메일에 첨부하여 전송하는 방법](https://help.directcloud.net/user_manual/undefined-4/undefined-2)

    , [사용자 페이지에서 Guest를 초대하는 방법](https://help.directcloud.net/user_manual/undefined-4/guest), [Connect User를 초대하는 방법](https://help.directcloud.net/user_manual/undefined-4/connect-user), [업로드 요청 폴더에 파일을 업로드하는 방법](https://help.directcloud.net/user_manual/undefined-4/undefined-1), 첨부 파일 전송, Guest 초대, 업로드 요청 화면 중 하나를 표시합니다.
...
1. 사용자 페이지에서 [\[Mobile\] 링크를 생성해 공유하는 방법](https://help.directcloud.net/user_manual/undefined-4/mobile-1), [\[Mobile\] 계정이 없는 상대로부터 파일을 받는 방법(업로드 요청 기능)](https://help.directcloud.net/user_manual/undefined-4/connect-user)에 따라 공유 링크 또는 업로드 요청 화면 중 하나를 표시합니다.<br>
