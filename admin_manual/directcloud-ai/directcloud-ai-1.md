...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-ai/directcloud-ai-1
---
...
* 이 매뉴얼 의 설정을 진행하시려면, [DirectCloud AI를 활성화하는 방법](https://help.directcloud.net/admin_manual/directcloud-ai/directcloud-ai)에 따라 DirectCloud AI가 사용함으로 설정되어 있어야 합니다.
