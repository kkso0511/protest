...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-ai/directcloud-ai
---
...
9. 관리 페이지 및 사용자 페이지의 폴더 속성에 'DirectCloud AI'가 표시되어 있는지 확인합니다.\
   자세한 내용은 [특정 폴더에서 DirectCloud AI를 활성화하는 방법](https://help.directcloud.net/admin_manual/directcloud-ai/directcloud-ai-1) 및 [사용자 페이지의 특정 폴더에서 DirectCloud AI를 활성화하는 방법](https://help.directcloud.net/user_manual/directcloud-ai/directcloud-ai)을 참조해 주십시오.
