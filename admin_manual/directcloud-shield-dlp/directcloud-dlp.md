...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-shield-dlp/directcloud-dlp
---
...
* Web 브라우저에서 파일을 온라인 편집할 때의 작업 제한 내용은 [파일을 다운로드 하지 않고 온라인으로 편집할 수 있도록 설정하는 방법](https://help.directcloud.net/admin_manual/undefined-6/undefined-3)에 따라 달라집니다.
