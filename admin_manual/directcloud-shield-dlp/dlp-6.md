...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-shield-dlp/dlp-6
---
...
* DLP 관리의 폴더 속성에서 PDF 다운로드를 활성화하려면, ['DLP 설정'에서 사용자가 파일을 다운로드 할 수 있도록 설정하는 방법](https://help.directcloud.net/admin_manual/directcloud-shield-dlp/dlp-1)의 절차에 따라 'SHIELD' > 'DLP 설정' 메뉴의 파일 반출 설정 탭에서 다운로드 설정의 사용이 선택되어 있어야 합니다.
