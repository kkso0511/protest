...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/dcmigrator/dcmigrator-3
---
...
* 이 매뉴얼의 제한 사항·추가 설명 및 기본적인 사용 방법에 대해서는 [DCMigrator를 사용하여 데이터를 마이그레이션하는 방법](https://help.directcloud.net/admin_manual/dcmigrator/dcmigrator-1)을 참조해주시기 바랍니다.
...
기타 명령줄 옵션에 대해서는 [DCMigrator를 사용하여 데이터를 마이그레이션하는 방법](https://help.directcloud.net/admin_manual/dcmigrator/dcmigrator-1)의 "DCMigrator의 명령줄 옵션" 항목을 참조해주시기 바랍니다.
