...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/dcmigrator/dcmigrator-2
---
...
* DCMigrator를 다운로드 하는 방법은 [DCMigrator 애플리케이션을 다운로드 하는 방법](https://help.directcloud.net/admin_manual/dcmigrator/dcmigrator)을 참조하십시오.
