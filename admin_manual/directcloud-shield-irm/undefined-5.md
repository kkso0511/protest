...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-shield-irm/undefined-5
---
...
이 매뉴얼 에서는, [외부로 반출되는 파일의 보안을 설정하는 방법](https://help.directcloud.net/admin_manual/directcloud-shield-irm/undefined-4)에서 설정된 작업 제한 범위 내에서 파일을 열람하거나 사용할 수 있는 SHIELD 사용자(IRM 사용 권한 사용자)를 추가하는 방법을 설명합니다.
