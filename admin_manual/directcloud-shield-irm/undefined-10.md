...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-shield-irm/undefined-10
---
...
*   '반출문서 이용내역'에는 다운로드 또는 링크 전송을 통해 외부로 반출된 파일이 표시됩니다.
    ...
    Shared Box에서 보안등급 라벨이 부여된 파일 목록을 확인하려면, [파일의 보안등급을 변경하는 방법](https://help.directcloud.net/admin_manual/directcloud-shield-irm/undefined-7)을 참고해주시기 바랍니다.
