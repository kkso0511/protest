...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/undefined-4/undefined-22
---
...
* [관리자 페이지에서 폴더를 생성하는 방법](https://help.directcloud.net/admin_manual/undefined-4/undefined)의 알림 설정에서 지정한 내용이 반영됩니다.
* 메일 알림은 [알림 메일을 수신할지 여부를 사용자 페이지에서 설정하는 방법](https://help.directcloud.net/user_manual/undefined-13/undefined-3)에서, 사용자 페이지의 알림 설정을 수신함으로 지정한 경우에만 유효합니다.
