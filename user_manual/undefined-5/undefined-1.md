...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/user_manual/undefined-5/undefined-1
---

# 사용자 페이지에서 사용자의 접근 권한을 변경하는 방법

### 개요 <a href="#a03" id="a03"></a>

이 매뉴얼에서는 <전체권한> 접근 권한이 부여된 사용자가 사용자 페이지에서 다른 사용자의 접근 권한을 변경하는 방법에 대해 설명합니다.
...
{% hint style="warning" %}
**사용자 또는 Guest의 접근 권한 변경**
{% endhint %}

&#x20;**\[접근 권한을 변경할 폴더 선택]**

1. 접근 권한을 변경할 폴더를 클릭합니다.

<figure><img src="../../.gitbook/assets/스크린샷 2025-11-03 142151.png" alt=""><figcaption></figcaption></figure>
...
&#x20;      사용자 액세스 권한 설정 화면이 표시됩니다.



2. 접근 권한을 변경하려는 그룹 또는 사용자의 드롭다운 목록에서 설정하려는 권한을 선택합니다.
...
2. 권한을 변경하려는 Guest의 드롭다운 목록에서 설정할 권한을 선택합니다.
