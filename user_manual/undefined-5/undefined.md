...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/user_manual/undefined-5/undefined
---

# 사용자 페이지에서 사용자에게 접근 권한을 부여하는 방법

### 개요 <a href="#a03" id="a03"></a>

이 매뉴얼에서는 <전체권한> 접근 권한이 부여된 사용자가 사용자 페이지에서 다른 사용자에게 접근 권한을 부여하는 방법에 대해 설명합니다.
...
* ‘접근 권한 레벨’은, 접근 권한이 부여된 폴더 내의 폴더나 파일에 대해 어떤 작업이 가능한지를 정의한 것입니다.\
  접근 권한의 상세 내용은 [접근 권한의 종류와 Web 브라우저에서 가능한 작업](https://help.directcloud.net/user_manual/undefined-5/web)을 참조해주시기 바랍니다.
...
* DirectCloud-SHIELD DLP를 이용 중인 경우 ‘DLP’ 메뉴가 표시됩니다.
...
{% hint style="warning" %}
**사용자 또는 Guest에게 접근 권한 부여**
{% endhint %}

**\[접근 권한을 추가할 폴더 선택]**

1. 접근 권한을 추가할 폴더를 클릭합니다.

<figure><img src="../../.gitbook/assets/스크린샷 2025-11-03 135334.png" alt=""><figcaption></figcaption></figure>



**\[그룹 사용자에게 접근 권한 및 접근 수준 부여]**

1. 슬라이드 화면의 '폴더 속성' 설정에서 '그룹/사용자'의 '권한관리' 버튼을 클릭합니다.
...
&#x20;      폴더 접근 권한이 설정되고 슬라이드 화면으로 돌아갑니다.



8. 공유한 사용자의 사용자/그룹 아이콘에 추가한 그룹 사용자의 수가 추가되었는지 확인합니다.
...
2. 접근 권한과 접근 수준을 부여할 Guest를 선택합니다.
...
5. 공유한 사용자의 Guest 아이콘에 추가한 Guest 수가 추가되었는지 확인합니다.
