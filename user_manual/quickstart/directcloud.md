...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/user_manual/quickstart/directcloud
---
...
* [사용자가 이용할 수 있는 애플리케이션을 제한하는 방법](https://help.directcloud.net/admin_manual/images-and-media/undefined-9)에서 'DirectCloud 드라이브'가 허용되어 있지 않은 경우에는, DirectCloud 드라이브에 로그인할 수 없습니다.
* DirectCloud 드라이브에서 가능한 조작에 대해서는, [접근 권한의 종류와 DirectCloud 드라이브 에서 가능한 조작](https://help.directcloud.net/user_manual/undefined-5/directcloud)을 참조해 주십시오.
