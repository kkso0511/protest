...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/user_manual/undefined-3/web-drive-5
---
...
* Warm Storage 관련 폴더 및 파일의 조작 방법은\
  [\[Web, Drive\] Warm Storage로 폴더 또는 파일을 이동하는 방법](https://help.directcloud.net/user_manual/undefined-3/web-drive-warm-storage) 및 [사용자 페이지에서 Ghost(고스트) 파일을 조작하는 방법](https://help.directcloud.net/user_manual/undefined-3/ghost)을 참고해 주십시오.
*   Cold Storage에서는 아래 방향으로 폴더 및 파일을 이동할 수 있습니다.
    ...
    * Hot Storage     ➡️ Cold Storage\
    ...
    Cold Storage의 파일을 Shared Box로 복원하는 작업에 대해서는 [Cold Storage의 파일을 복원하는 방법](https://help.directcloud.net/user_manual/cold-storage/cold-storage-1)을 참고해 주십시오.
...
*   DirectCloud AI가 활성화된 폴더로 파일을 복사하거나 이동하는 경우, 벡터 데이터가 생성됩니다.\
    ...
    DirectCloud AI가 생성하는 벡터 데이터 관련 상세 내용은 [DirectCloud AI 사양 및 참고 사항](https://help.directcloud.net/admin_manual/directcloud-ai/directcloud-ai-4)을 참고해 주십시오.
...
* Warm Storage와 Cold Storage의 사양에 대해서는\
  [Warm Storage와 Cold Storage의 차이](https://help.directcloud.net/user_manual/undefined-14/warm-storage-cold-storage)를 참고해 주십시오.
