...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/user_manual/undefined-3/undefined-1
---
...
* 이전 버전 파일은 스토리지의 [계약 용량과 사용 용량을 확인하는 방법](https://help.directcloud.net/admin_manual/undefined-8/undefined)으로 확인할 수 있습니다.
* [동일한 이름의 파일을 업로드했을 때의 처리 방법](https://help.directcloud.net/admin_manual/undefined/undefined-1)이 파일 덮어쓰기 설정으로 되어 있는 경우, 동일한 이름의 파일을 업로드하면 파일의 버전이 갱신됩니다.
