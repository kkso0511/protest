...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/user_manual/undefined-9/undefined
---
...
* 워크플로우를 생성하는 관리자는 관리 페이지에서 '결재선관리 담당자'로 설정되어 있어야 합니다.\
  자세한 내용은 [워크플로우를 활성화하는 방법](https://help.directcloud.net/admin_manual/undefined-7/undefined)을 참조해주시기 바랍니다.
