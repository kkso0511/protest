...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/user_manual/undefined-15/web-drive-1
---
...
* [\[Web, Drive\] 링크를 생성해 공유하는 방법](https://help.directcloud.net/user_manual/undefined-4/web-drive)
* [파일을 이메일에 첨부하여 전송하는 방법](https://help.directcloud.net/user_manual/undefined-4/undefined-2)
* [\[Web, Drive\] 계정이 없는 상대로부터 파일을 받는 방법(업로드 요청 기능)](https://help.directcloud.net/user_manual/undefined-4/web-drive-10)
* [사용자 페이지에서 Guest를 초대하는 방법](https://help.directcloud.net/user_manual/undefined-4/guest)
* [Connect User를 초대하는 방법](https://help.directcloud.net/user_manual/undefined-4/connect-user)
