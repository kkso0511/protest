...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/user_manual/troubleshooting/user_login
---
...
통신 허용이 필요한 도메인에 대해서는 [DirectCloud 공통 사양](https://help.directcloud.net/user_manual/specification/common_specification)의 포트 번호 및 도메인 액세스 제어 정보를 참고해 주시기 바랍니다.
