...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/user_manual/workflow/cancel_workflow
---
...
이 매뉴얼에서는 Web 브라우저와 DirectCloud 드라이브에서 이미 제출한 워크플로우를 철회하는 방법에 대해 설명합니다.
...
* 상태가 승인 대기 또는 거절 이외인 신청은 철회할 수 없습니다.
* 한 번 철회한 워크플로우는 다시 활성화할 수 없습니다.
...
{% hint style="warning" %}
**Web 브라우저에서 워크플로우 신청을 철회**
{% endhint %}

워크플로우 신청자는 본인이 결재 요청을 제출한 이후, 결재자가 해당 신청을 확인하기 전까지는 신청 내용을 철회할 수 있습니다.
...
신청서가 취소되고 "해당 워크플로우가 회수되었습니다."라는 메시지가 표시됩니다.\
철회된 신청 상태는 '회수'로 표시됩니다.\
또한 결재자와 대리 결재자에게 "워크플로우가 취소되었습니다."라는 제목의 알림 메일이 전송됩니다.
