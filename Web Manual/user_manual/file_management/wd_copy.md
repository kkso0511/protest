...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/user_manual/file_management/wd_copy
---
...
*   DirectCloud AI가 활성화된 폴더로 파일을 복사하거나 이동하는 경우, 벡터 데이터가 생성됩니다.\
    ...
    DirectCloud AI에서 생성되는 벡터 데이터에 대한 상세 내용은 [DirectCloud AI 사양 및 참고 사항](https://help.directcloud.net/user_manual/specification/ai_specification)을 참고해 주십시오.
