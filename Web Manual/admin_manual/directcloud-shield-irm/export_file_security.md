...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-shield-irm/export_file_security
---
...
이 매뉴얼에서는, [보안문서 판정 기준 설정 방법](https://help.directcloud.net/admin_manual/directcloud-shield-irm/security_criteria)에서 설정한 문서 속성에 따라 외부로 반출된 파일의 보안 설정(사용 가능한 사용자, 유효 기간, 개봉 횟수 등)을 지정하는 방법에 대해 설명합니다.
...
2. 동작 열에 표시된 버튼을 클릭합니다.\
   업로드 대상 파일이, [보안 문서 판단 기준 설정 방법](https://help.directcloud.net/admin_manual/directcloud-shield-irm/security_criteria)에서 지정한 문서 속성 중 어느 항목에 해당하는지 확인한 뒤, 그에 맞는 보안수준을 선택합니다.
