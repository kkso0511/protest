...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-shield-irm/criteria_bulk_register
---
...
문서 속성은 [보안문서 판정 기준 설정 방법](https://help.directcloud.net/admin_manual/directcloud-shield-irm/security_criteria)에서 속성별로 개별 등록할 수 있지만, 이 매뉴얼 에서 설명하는 절차에 따라 문서 속성 추가용 CSV 파일을 생성하여 가져오기를 수행하면 일괄 등록이 가능합니다.\
