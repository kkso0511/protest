...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-shield-irm/auto_security_upload
---
...
이 매뉴얼 에서는 [보안문서 판정 기준 설정 방법](https://help.directcloud.net/admin_manual/directcloud-shield-irm/security_criteria)에서 생성한 문서 속성에 따라 다음 처리가 이루어지도록 설정하는 방법을 설명합니다.
