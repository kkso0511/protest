...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/user/connect_admin_approval
---

# 관리자 승인 후 Connect 초대 메일을 발송하도록 설정하는 방법

### 개요 <a href="#a03" id="a03"></a>

Connect는 DirectCloud 회사 ID를 보유한 테넌트 간에 지정한 폴더를 공유할 수 있는 기능입니다.\
이 매뉴얼에서는 ‘Connect User’ 메뉴에서 사내 사용자가 지정한 폴더에 외부 멤버를 Connect로 초대했을 때, 관리자 승인을 거치도록 설정하는 방법에 대해 설명합니다.
...
* <마스터> 권한의 사용자는 Connect 초대를 승인할 수 없습니다.
...
2. ‘관리자 승인한 초대장만 발송’에서 ‘예’를 선택한 후, ‘저장’ 버튼을 클릭합니다.
