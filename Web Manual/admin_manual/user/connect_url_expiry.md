...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/user/connect_url_expiry
---

# Connect 등록용 URL의 유효기간을 변경하는 방법

### 개요 <a href="#a03" id="a03"></a>

Connect는 DirectCloud 회사 ID를 보유한 테넌트 간에 지정한 폴더를 공유할 수 있는 기능입니다.\
이 매뉴얼에서는 ‘Connect User’ 메뉴에서 사내 사용자가 Connect User를 초대했을 때 발송되는 등록용 URL의 유효기간을 설정하는 방법에 대해 설명합니다.
...
2. ‘Connect User 초대 링크 유효기간’의 일수를 ‘1 \~ 5’중에서 지정한 후, ‘저장’ 버튼을 클릭합니다.
