...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/log/file_attach_email_history
---
...
* [사용자 페이지에서 파일첨부 메일발송의 이용 내역을 확인하는 방법](https://help.directcloud.net/user_manual/management_history/mail_history)을 통해서도, 첨부 파일 발송 이력을 확인할 수 있습니다.
...
| 제목    | <p>첨부 파일 발송 메일의 제목이 표시됩니다.<br>클릭하면 '상세' 화면에 첨부 파일 발송 메일의 상세 정보가 표시됩니다.<br>자세한 내용은 <a href="https://help.directcloud.net/user_manual/file_share/attachment_mail">파일을 이메일에 첨부하여 전송하는 방법</a>을 참조해 주십시오.</p> |
