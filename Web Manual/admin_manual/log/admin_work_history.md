...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/log/admin_work_history
---
...
* Connect User를 초대받은 쪽의 회사 ID 관리 페이지에서는, Connect 폴더의 조작 로그를 취득할 수 없습니다.\
  단, [DirectCloud를 사용하는 다른 회사로부터의 Connect User 초대를 허용하는 방법](https://help.directcloud.net/admin_manual/detail_settings/allow_connect_invite)에 따라 초대를 수락한 Connect User의 조작 이력은 취득할 수 있습니다.
