...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/custom_settings/drive_letter
---
...
* 본 매뉴얼의 절차에 따라 드라이브 문자를 지정한 경우, 사용자 페이지에서는 [DirectCloud 드라이브에서 폴더 경로에 할당된 드라이브 문자를 확인하는 방법](https://help.directcloud.net/user_manual/account_settings/d_letter)의 절차로 드라이브 문자를 변경할 수 없게 됩니다.
