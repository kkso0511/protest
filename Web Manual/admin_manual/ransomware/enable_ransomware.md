...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/ransomware/enable_ransomware
---
...
이 매뉴얼에서는 관리 페이지에서 랜섬웨어 방지 기능을 활성화하는 방법에 대해 설명합니다.
...
2. '랜섬웨어 방지' 사용 설정에서 '사용'을 선택하고 저장 버튼을 클릭합니다.
...
이 매뉴얼 및 아래 매뉴얼의 절차에 따라 프로그램이 차단되면 "알려지지 않은 프로그램의 파일 변조 시도로 접근을 차단했습니다." 라는 메시지가 표시됩니다. \
또한 프로그램 차단 이력에 로그가 기록됩니다.

* [랜섬웨어 방지 기능을 사용하는 방법](https://help.directcloud.net/admin_manual/ransomware/enable_ransomware)
...
프로그램 차단 이력은 관리자 페이지와 사용자 페이지에서 확인할 수 있습니다.

* 관리 페이지

<div align="left"><figure><img src="../../.gitbook/assets/image (2154).png" alt=""><figcaption></figcaption></figure></div>
