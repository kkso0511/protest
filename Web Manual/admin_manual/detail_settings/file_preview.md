...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/detail_settings/file_preview
---

# 파일을 다운로드하지 않고 미리 볼 수 있도록 설정하는 방법

### 개요 <a href="#a03" id="a03"></a>

DirectCloud에는 파일을 다운로드하지 않는 미리보기 기능이 있습니다.\
이 매뉴얼에서는 미리보기 설정에서 파일 미리 보기를 사용하도록 설정하는 방법에 대해 설명합니다.
...
* <업로더> 권한의 사용자는 파일 미리보기 기능을 사용할 수 없습니다.
* '미리보기 설정'에서 '사용'을 선택하면, 폴더에 저장된 파일뿐만 아니라, 링크 수신 화면의 파일도 전용 뷰어로 미리보기할 수 있게 됩니다.
* 파일을 지정하여 미리보기를 활성화하거나 비활성화할 수 없습니다.
* 폴더의 공유 링크를 작성·송신해도 '로그 현황' ＞ '링크 이력'에 폴더의 액세스 로그는 남지 않습니다.
* 폴더에 저장된 파일에 대한 액세스 로그는 유지됩니다.
* DirectCloud 드라이브에서는, My Box, Shared Box, DLP 폴더, Warm Storage에 저장되어 있는 동영상·음성 파일을 미리보기할 수 없습니다. 다만, 탐색기에서 파일을 더블클릭하면, 다른 애플리케이션으로 파일을 직접 열 수 있습니다.
* 탐색기에서 파일을 열기 위해서는 <마스터>, <전체권한>, <편집자>의 접근 권한이 부여되어 있어야 합니다.
...
1. 미리보기 설정에서 '문서'에 '사용'을 선택하고 저장을 클릭합니다.
...
1. 미리보기 설정에서 '미디어'에 '사용'을 선택하고 저장을 클릭합니다.
