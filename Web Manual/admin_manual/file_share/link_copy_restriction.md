...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/file_share/link_copy_restriction
---

# 공유 링크 생성 화면에서 링크 복사를 사용하지 않도록 설정하는 방법

### 개요 <a href="#a03" id="a03"></a>

이 매뉴얼에서는 ‘링크 옵션 설정’에서 링크 생성 화면의 링크 공유 방법으로 ‘링크 복사’를 사용할 수 없도록 제한하는 방법에 대해 설명합니다.
...
* 워크플로우에서 '링크'의 '신청자'로 설정된 사용자의 경우 공유 링크 생성 화면에 '링크 복사' 아이콘이 표시되지 않습니다.
...
2. '링크생성 시 기본값 설정'의 '링크 발송방법 제어'에서 '링크 복사버튼 표시'를 선택을 해제합니다.
...
1. 공유 링크 생성 화면에서 '링크 복사' 아이콘이 표시되지 않는지 확인합니다.
