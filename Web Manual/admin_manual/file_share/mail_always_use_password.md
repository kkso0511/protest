...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/file_share/mail_always_use_password
---

# 파일첨부 메일발송 화면에서 비밀번호 설정을 강제하는 방법

### 개요 <a href="#a03" id="a03"></a>

이 매뉴얼에서는 ‘파일첨부 메일발송 시 비밀번호 설정’에서 관리자가 설정한 파일첨부 메일발송 비밀번호를 사용자에게 강제로 적용하고, 파일첨부 메일발송 화면에서 변경할 수 없도록 설정하는 방법에 대해 설명합니다.
...
2. '파일직접첨부 이메일 발송 시 비밀번호 옵션'의 '비밀번호'에서 '사용'을 선택합니다.
...
1. 첨부파일 보내기 화면에서 비밀번호를 비활성화할 수 없는지 확인합니다.
