...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/group/group_csv_upload
---
...
*   템플릿으로 다운로드되는 텍스트 파일의 문자 코드는 ‘공유 설정’ > ‘세부 기능 설정’ 메뉴에 있는 ‘문자 인코딩’에서 지정되어 있습니다.
    ...
    자세한 내용은 [다운로드하는 CSV 파일의 문자 코드를 설정하는 방법](https://help.directcloud.net/admin_manual/detail_settings/csv_encoding)을 참고해 주세요.
