...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-shield-dlp/folder_file_download
---

# DLP 폴더 속성에서 파일 다운로드 기능을 활성화하는 방법

### 개요

이 매뉴얼 에서는 DLP 폴더를 선택한 후 폴더 속성에서 파일 다운로드를 활성화하는 방법에 대해 설명합니다.

### 제한·보충사항 <a href="#a04" id="a04"></a>

* 관리자 권한이 부여된 사용자는 관리자 페이지에서 '공유 설정'  항목에 접근할 수 있습니다.
* DLP 관리의 폴더 속성에서 PDF 다운로드를 활성화하려면, ['DLP 설정'에서 사용자가 파일을 다운로드 할 수 있도록 설정하는 방법](https://help.directcloud.net/admin_manual/directcloud-shield-dlp/allow_file_download)의 절차에 따라 'SHIELD' > 'DLP 설정' 메뉴의 파일 반출 설정 탭에서 다운로드 설정의 사용이 선택되어 있어야 합니다.
* 다운로드 설정은 기본적으로 사용으로 설정되어 있습니다.
* 다운로드 설정은 제1계층 폴더에 대해 설정하며, 설정한 내용은 하위 폴더에 그대로 적용됩니다.
...
2. 화면을 아래로 스크롤하여 폴더 속성 설정에서 다운로드 설정의 수정 버튼을 클릭합니다.
