...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/directcloud-shield-dlp/folder_file_attach_email
---
...
* DLP 관리의 폴더 속성에서 파일첨부 메일발송을 활성화하려면, ['DLP 설정'에서 사용자에게 파일첨부 메일발송 기능을 허용하는 방법](https://help.directcloud.net/admin_manual/directcloud-shield-dlp/allow_file_attach_email)의 절차에 따라 'SHIELD' > 'DLP 설정' 메뉴의 파일 반출 설정 탭에서 파일첨부 메일발송 설정의 사용이 선택되어 있어야 합니다.
