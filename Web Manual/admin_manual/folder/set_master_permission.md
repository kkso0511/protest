...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/folder/set_master_permission
---
...
* 각 마스터 권한에는 아래와 같은 차이가 있습니다.\
  자세한 내용은 [접근 레벨의 종류와 Web 브라우저에서 가능한 작업](https://help.directcloud.net/user_manual/access_permission/w_permission)을 참고해 주십시오.
  * 마스터\
