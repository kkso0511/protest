...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/folder/warm_storage_auto_move
---
...
* 파일이 Warm Storage로 자동 이동되면 로그 > 파일의 조작 메뉴에 자동 이동 로그가 기록됩니다. 파일이 자동 이동될 때 생성되는 폴더에 대한 로그는 기록되지 않습니다.
...
* 다음 작업 중 하나라도 수행되어 대상 폴더에 저장된 파일에 접근이 발생하면, 해당 파일의 마지막 접속 일시가 갱신됩니다.
  ...
  * 링크 생성\
    \
    이 작업들에 대한 로그는 로그 > 파일의 조작 메뉴의 액션 항목에서 확인할 수 있습니다.
* 사용자 페이지에서는 파일의 접근 이력 화면에서 마지막 접속 일시와 작업 등의 기록을 확인할 수 있습니다.
