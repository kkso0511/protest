...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/folder/sharedbox_delete_permission
---

# Shared Box에 대한 접근 권한을 삭제하는 방법

### 개요 <a href="#a03" id="a03"></a>

이 매뉴얼에서는 사용자, 그룹, Guest 사용자에게 부여한 폴더에 대한 권한을 삭제하는 방법에 대해 설명합니다.
...
* 접근 권한 설정 버튼을 눌러도 반응이 없는 경우에는 웹 브라우저의 캐시를 삭제한 후 다시 실행해주시기 바랍니다.
...
{% hint style="warning" %}
**Shared Box의 사용자 권한 삭제**
{% endhint %}

**\[Shared Box 설정 화면 표시]**

1. '공유 설정' > 'Shared Box 관리' 메뉴를 선택하고 권한을 삭제할 폴더를 클릭합니다.
...
1. Shared Box 설정 화면의 '구성원 관리'에서 그룹/사용자의 오른쪽에 표시되는 '권한관리' 버튼을 클릭합니다.\
   권한 설정 화면이 표시됩니다.
...
2. 권한을 삭제할 그룹 또는 사용자의 '×' 버튼을 클릭합니다. \
...
4. 구성원 관리의 그룹/사용자 아이콘에서 삭제된 그룹 사용자 수가 줄어들었는지 확인하십시오.
...
1. Shared Box 설정 화면의 '구성원 관리'에서 Guest 오른쪽에 표시되는 '권한관리' 버튼을 클릭합니다.\
   Guest 권한 설정 화면이 표시됩니다.

<figure><img src="../../.gitbook/assets/image (1920).png" alt=""><figcaption></figcaption></figure>

&#x20;     &#x20;

2. 권한을 삭제할 Guest의 '×' 버튼을 클릭합니다.\
