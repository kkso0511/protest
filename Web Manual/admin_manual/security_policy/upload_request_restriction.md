...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/security_policy/upload_request_restriction
---

# 특정 그룹이나 사용자에게 업로드 요청 기능을 사용하지 못하도록 설정하는 방법

### 개요 <a href="#a03" id="a03"></a>

이 매뉴얼에서는 '보안 정책'> '사용 권한'메뉴에서 그룹이나 사용자에게 적용되는 업로드 요청 기능을 제외하는 방법에 대해 설명합니다.
...
2. 설정 이름을 입력하여 적용할 기능을 선택합니다. 'File Request' 항목의 체크를 해제한 상태에서 '저장' 버튼을 클릭합니다.
...
{% hint style="warning" %}
**그룹에 적용된 업로드 요청 기능 제외**
{% endhint %}

1. '계정 관리' > '사용자' 메뉴를 선택하고 업로드 요청 기능을 제외할 그룹을 선택한 다음 편집 버튼을 클릭합니다.
...
{% hint style="warning" %}
**사용자에게 적용되는 업로드 요청 기능 제외**
{% endhint %}

1. '계정 관리' > '사용자' 메뉴를 선택하고 업로드 요청 기능을 제외할 사용자를 선택하고 편집 버튼을 클릭합니다.
