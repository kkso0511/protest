...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/security_policy/link_restriction
---

# 특정 그룹이나 사용자에게 공유 링크 사용을 허용하지 않도록 설정하는 방법

### 개요 <a href="#a03" id="a03"></a>

이 매뉴얼에서는 '보안 정책'> '사용권한' 메뉴에서 그룹이나 사용자에게 적용된 공유 링크 기능을 제외하는 방법에 대해 설명합니다.
...
* 사용 권한 설정 메뉴의 설정은 Guest에게는 적용되지 않습니다.\
  Guest에게 링크 기능을 사용하도록 할지 여부는 '계정관리' > 'Guest' 메뉴에서 설정할 수 있습니다.
...
2. 권한 이름을 입력하여 적용할 기능을 선택합니다. 'File Link' 항목의 선택을 취소한 상태에서 '저장' 버튼을 클릭합니다.
...
1. '계정 관리' > '사용자' 메뉴를 선택하고 공유링크 기능을 제외할 그룹을 선택한 다음 수정 버튼을 클릭합니다.
...
{% hint style="warning" %}
**사용자에게 적용된 공유 링크 기능 제외**
{% endhint %}

1. '계정 관리' > '사용자' 메뉴를 선택하고 공유 링크 기능을 제외할 사용자를 선택하고 편집 버튼을 클릭합니다.
