...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/security_policy/mail_restriction
---

# 특정 그룹이나 사용자에게 첨부파일 전송 기능을 사용하지 못하도록 설정하는 방법

### 개요 <a href="#a03" id="a03"></a>

이 매뉴얼에서는 '보안 정책'> '사용권한' 메뉴에서 그룹이나 사용자에게 적용된 첨부 파일 기능을 제외하는 방법에 대해 설명합니다.
...
2. 설정 이름을 입력하여 적용할 기능을 선택합니다. "Email" 항목을 선택 취소한 상태에서 "저장" 버튼을 클릭합니다.
...
{% hint style="warning" %}
**그룹에 적용된 첨부파일 전송 기능 제외**
{% endhint %}

1. '계정 관리' > '사용자' 메뉴를 선택하고 첨부 파일 전송 기능을 제외할 그룹을 선택한 다음 편집 버튼을 클릭합니다.
...
{% hint style="warning" %}
**사용자에게 적용된 첨부파일 전송 기능 제외**
{% endhint %}

1. '계정 관리' > '사용자' 메뉴를 선택하고 첨부파일 전송 기능을 제외할 사용자를 선택하고 편집 버튼을 클릭합니다.
