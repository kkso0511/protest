...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/FRc8hBWqHCHYh3E0AhFb/admin_manual/security_policy/password_type
---

# 로그인 비밀번호의 문자 유형을 제한하는 방법

### 개요 <a href="#a03" id="a03"></a>

이 매뉴얼에서는, ‘비밀번호 정책’ 메뉴에서 사용자 및 Guest가 로그인 비밀번호로 사용할 수 있는 문자 종류를 제한하는 방법에 대해 설명합니다.
...
2. 암호 제한에서 암호 입력 규칙을 선택하고 저장 버튼을 클릭합니다.
